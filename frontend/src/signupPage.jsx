  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-600 to-blue-500 p-6">
      <div className="bg-white/90 backdrop-blur-md p-8 rounded-xl shadow-lg w-full max-w-md text-center">
        <h1 className="text-3xl font-bold text-purple-600 mb-4">🎭 Join the Fun! 🎭</h1>
        <p className="text-gray-700 mb-6">Sign up to unlock the best excuses of all time!</p>
        ...
        <div className="mt-4 text-sm text-gray-700">
          <p>Already have an account? <Link to="/login" className="text-purple-500 font-bold">Login</Link></p>
        </div>
